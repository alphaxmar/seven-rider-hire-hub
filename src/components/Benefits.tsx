  ...
  const benefits = [
    {
      ...
      title: "รายได้ดี",
      description: "รายได้เฉลี่ย 15,000-30,000 บาท/เดือน (ขึ้นอยู่กับสาขาและจำนวนบิล)",
      detail: "เงินรอบแรกจะได้หลังจากเริ่มงาน11 วัน รอบต่อไปจะจ่ายทุก3วัน (ตามระบบของบริษัท)"
    },
    {
