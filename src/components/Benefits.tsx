...
const Benefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      detail: "ร้านสะดวกซื้อแบรนด์โลก เชื่อถือได้ ไม่หายหน้าไปไหน"
    },
    {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            ทำไมคนเก่งถึงเลือก <span className="text-seven-green">ร้านสะดวกซื้อ</span><span className="text-seven-red">?</span>
          </h2>
